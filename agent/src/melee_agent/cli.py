...
def main(argv=None):
    ...
    match.add_argument("--policy", choices=("scripted", "smoke", "input-probe", "heuristic", "random-legal", "heuristic-tactical", "random-tactical", "delayed-fake", "jev"), default="scripted")
    ...
    capture.add_argument("--policy", choices=("scripted", "smoke", "delayed-fake", "jev", "faults", "heuristic", "random-legal", "heuristic-tactical", "random-tactical"), default="scripted")
