...
def audit_combat(spec, report, rows, errors):
    ...
    try:
        ...
        return audit_combat_trace(name, combat, rows, errors, completed=report["result"]["status"] == "succeeded")
    except (KeyError, TypeError, ValueError, IndexError):
        errors["combat_evidence_unavailable"] += 1
        return {"motion_acknowledged": False, "completed": False, "contact_events": 0, "capture_observed": False}
