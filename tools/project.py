...
class ProjectConfig:
    def __init__(self) -> None:
        ...
        # Additional source-only DOL units for explicitly opted-in mods.
        self.extra_dol_objects: List[str] = []
...
def generate_build_ninja(
    ...
    if build_config:
        ...
        for name in config.extra_dol_objects:
            add_unit({"object": None, "name": name, "autogenerated": True}, link_step)
